...
pow_spec_dens= 5; % can be added as function argument
...
noise_cov_mat_last(1:3, 1:3)= (1/3)*pow_spec_dens*(tau_s^3)*eye(3);

noise_cov_mat_last(1:3, 4:6)= (1/2)*pow_spec_dens*(tau_s^2)*eye(3);

noise_cov_mat_last(4:6, 1:3)= (1/2)*pow_spec_dens*(tau_s^2)*eye(3);

noise_cov_mat_last(4:6, 4:6)= pow_spec_dens*tau_s*eye(3);
